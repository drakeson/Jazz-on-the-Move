...
extension MainViewController: SideMenuViewControllerDelegate {
    func selectedCell(_ row: Int) {
        ...
        case 1:
            // Wine
            self.showViewController(viewController: UINavigationController.self, storyboardId: "WineNavID")
        case 2:
            // Coffee
            self.showViewController(viewController: UINavigationController.self, storyboardId: "CoffeeNavID")
        case 3:
            // Travel
            self.showViewController(viewController: UINavigationController.self, storyboardId: "TravelNavID")
        case 4:
            // Events
            self.showViewController(viewController: UINavigationController.self, storyboardId: "EventsNavID")
        case 5:
            // Lifestyle
            self.showViewController(viewController: UINavigationController.self, storyboardId: "LifestyleNavID")
        case 6:
            // Other
            print("https://drakeson.github.io")
            //self.showViewController(viewController: UINavigationController.self, storyboardId: "LifestyleNavID")
        case 7:
            // OnAir
            let safariVC = SFSafariViewController(url: URL(string: "https://www.facebook.com/dr.drakeson")!)
        ...
        case 9:
            // Instagram
            let safariVC = SFSafariViewController(url: URL(string: "https://www.twitter.com/dr_drakeson")!)
            present(safariVC, animated: true)
        case 10:
            // Instagram
            let safariVC = SFSafariViewController(url: URL(string: "https://www.instagram.com/dr.drakeson")!)
            present(safariVC, animated: true)
        default:
            break
        }
