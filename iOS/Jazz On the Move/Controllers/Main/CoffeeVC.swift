...
class CoffeeVC: UIViewController, KSICCoordinatorDelegate, UICollectionViewDelegate, UICollectionViewDataSource {
...
//        present(alert, animated: true, completion: nil)
    ...
    func loadSlider() {
        ...
        homeSlider.getDeals(Constants.coffeeURL)
    }
    ...
    func loadDeals() {
        ...
        dealsVM.getItems(Constants.FireBase.COFFEE)
    }
