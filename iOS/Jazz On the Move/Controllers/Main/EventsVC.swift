...
class EventsVC: UIViewController, KSICCoordinatorDelegate, UICollectionViewDelegate, UICollectionViewDataSource {
...
//        present(alert, animated: true, completion: nil)
    ...
    func loadSlider() {
        ...
        homeSlider.getDeals(Constants.eventsURL)
    }
    ...
    func loadDeals() {
        ...
        dealsVM.getItems(Constants.FireBase.EVENTS)
    }
}
