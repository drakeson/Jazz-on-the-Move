...
class TravelVC: UIViewController, KSICCoordinatorDelegate, UICollectionViewDelegate, UICollectionViewDataSource {
...
//        present(alert, animated: true, completion: nil)
    ...
    func loadSlider() {
        ...
        homeSlider.getDeals(Constants.travelURL)
    }
    ...
    func loadDeals() {
        ...
        dealsVM.getItems(Constants.FireBase.TRAVEL)
    }
